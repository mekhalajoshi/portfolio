		...
		return (
			<div className='project_card_container'>
				<Card style={styles.Card}>
					<a href={this.props.link} target='_blank' rel="noopener noreferrer" >
						<CardActionArea>
							...
							<CardContent style={styles.CardContent}>
								...
								<Typography style={styles.typography}  variant="body2" component="p">
									{this.props.description}
								</Typography>
								<Typography   style={{ marginTop: '10px',	fontFamily: 'Raleway' }} variant="subtitle2" component="p">
									{this.props.tags}
								</Typography>
							</CardContent>
						</CardActionArea>
					...
					<CardActions >
						<Button href={this.props.link} target='_blank' size="small" style={styles.Button}>
							Launch Project < PlayArrowIcon style={styles.Icon} />
						</Button>
						<Button href={this.props.GitHubLink} target='_blank' size="small" style={styles.Button}>
							View on Github &nbsp;
